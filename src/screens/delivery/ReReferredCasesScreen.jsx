...
const { useRef } = React;
const ReReferredCasesScreen = ({ navigation, route }) => {
        ...
        >
          ...
          <View style={styles.searchContainer}>
            ...
            <TextInput
              ...
              placeholder="Search by patient name, mobile, DP, or reason"
              value={searchQuery}
          ...
          <View style={styles.infoBanner}>
            ...
            <Text style={styles.infoText}>
              <Text style={styles.infoBold}>Re-referred Cases:</Text> These are cases you have referred to other delivery points for specialized care or capacity reasons.
            </Text>
          </View>
            ...
            <View style={styles.emptyContainer}>
              {searchQuery.trim() !== '' ? (
                ...
                <>
                  ...
                  <Text style={styles.emptySubtitle}>You haven't referred any cases to other delivery points yet</Text>
                </>
              )}
            </View>
          ) : (
            ...
            <View style={styles.casesList}>
              ...
              >
                <Text style={styles.guidelinesText}>
                  <Text style={styles.guidelinesBold}>Information:</Text> These cases have been successfully referred to other delivery points. You can track their status and view referral details here.
                </Text>
              </LinearGradient>
            </>
          )}
