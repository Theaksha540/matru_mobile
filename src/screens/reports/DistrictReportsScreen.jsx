...
const DistrictReportsScreen = ({ navigation }) => {
  ...
  const summaryStats = reportData ? [
    { id: 1, value: reportData.district_summary?.total_pregnant_women?.toString() || '0', label: t('totalCases') },
    { id: 2, value: reportData.district_summary?.high_risk_cases?.toString() || '0', label: t('highRisk') },
    { id: 3, value: `${reportData.usg_statistics?.completion_rate?.toFixed(0) || 0}%`, label: t('usgRate') },
  ] : [
    { id: 1, value: '0', label: t('totalCases') },
    { id: 2, value: '0', label: t('highRisk') },
    { id: 3, value: '0%', label: t('usgRate') },
  ];
  ...
  const handleDownloadReport = async (format) => {
    ...
    try {
      ...
      const downloadUrl = buildApiUrl(
        `/api/v1/reports/district/export/${format}`,
